  ...
  return (
    <div className="relative w-full h-[400px] rounded-lg overflow-hidden border border-border">
      ...
      <div className="absolute bottom-4 right-4 glass rounded-lg px-3 py-2">
        <p className="text-xs font-mono text-muted-foreground">Mock Map</p>
      </div>
    </div>
  );
};
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Draw and manage delivery zones
          </p>
        </div>
        <Button
                    ...
                    {zones.map((zone) => (
                      ...
                      >
                        <div className="flex items-start justify-between">
                          ...
                          <div className={`w-2 h-2 rounded-full ${zone.is_active ? "bg-green-500" : "bg-red-500"}`} />
                        </div>
